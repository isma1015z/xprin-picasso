  ...
  return (
    <div className="relative min-h-screen bg-brand-dark overflow-hidden font-sans">
      ...
      <div className={`fixed inset-0 z-50 bg-brand-white pointer-events-none flex flex-col items-center justify-center transition-transform duration-[1500ms] ease-in-out ${isPrinting ? 'translate-y-0' : '-translate-y-full'}`}>
        ...
        <h2 className="text-2xl font-bold text-brand-dark tracking-[0.2em]">PREPARANDO SOPORTE...</h2>
      </div>
      ...
      <div className={`flex flex-col items-center justify-center min-h-screen text-center transition-opacity duration-1000 ${isPrinting ? 'opacity-0' : 'opacity-100'}`}>
        {/* Fondo */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_#1a1a1a_0%,_#0a0a0a_100%)] pointer-events-none" />
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#E41C24_1px,transparent_1px)] [background-size:32px_32px] pointer-events-none" />
