          ...
          <div className="mx-auto w-full max-w-sm lg:max-w-md animate-fade-in-up">
            ...
            {success ? (
              <div className="text-center py-8">
                ...
                <button onClick={() => { setIsPrinting(true); setTimeout(() => navigate('/login'), 1500); }}
              ...
              <>
                ...
                <div className="mt-10 text-center text-sm text-brand-carbon opacity-80">
                  ...
                  <Link to="/login" onClick={(e) => { e.preventDefault(); setIsPrinting(true); setTimeout(() => navigate('/login'), 1500); }}
                    className="font-semibold leading-6 text-brand-cyan hover:opacity-80 transition-colors uppercase tracking-widest text-[10px]">
                    Volver al acceso
                  </Link>
                </div>
              </>
